...
module.exports = () => {
    ...
    router.post('/create', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const response = Object.assign({}, APIResponse_model_1.default);
        try {
            const location = yield (0, Location_service_1.createLocation)(req.body);
    ...
    router.delete('/delete/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const location = yield (0, Location_service_1.deleteLocation)(Number(req.params.id));
            response.data = location;
            response.statusCode = 200;
            return res.status(201).json(response);
        }
    ...
    router.put('/edit/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const location = yield (0, Location_service_1.editLocation)(Number(req.params.id), req.body);
            response.data = location;
            response.statusCode = 200;
            return res.status(201).json(response);
        }
